...
interface ComponentManifest {
  ...
  personalityFit: {              // Which personality ranges this suits
    [axis: string]: [number, number];  // [min, max] range on each axis
  };
...
**Structural:**
- Header/Navigation (sticky, transparent, hamburger, mega-menu, centered logo)
- Footer (simple, multi-column, CTA, newsletter, minimal)
- Section Wrapper (controls spacing, backgrounds, containers)
- Page Layout (overall page structure, sidebar options)

**Hero Sections:**
- Centered text hero
- Split hero (image + text, left or right)
...
- **Luxury Dark** — Deep jewel tones, serif headings, generous space, gold accents
- **Luxury Light** — Cream/ivory base, elegant serif, subtle shadows, muted metallics
- **Modern Clean** — Crisp whites, geometric sans-serif, minimal color, sharp edges
- **Bold Creative** — Vibrant colors, display fonts, dynamic animations, asymmetric layouts
- **Warm Professional** — Earth tones, friendly sans-serif, rounded corners, accessible
...
- **intakeResponses** — Individual answers from the intake flow
